...
const handleLike = async () => {
  ...
  const { mutateAsync:toggleSubscribe } = useToggleSubscribe(video?.owner?._id as string,videoId as string);
    ...
    <div className="lg:w-8/12">
      <div className="aspect-video  mb-4">
        ...
        <div className="w-full h-full flex items-center justify-center text-2xl text-gray-500">
          ...
          videoUrl={video?.videoFile} thumbnailUrl={video?.thumbnail}
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-4 gap-4">
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">{video?.owner?.subscriberCount} subscribers</p>
          </div>
        </div>
